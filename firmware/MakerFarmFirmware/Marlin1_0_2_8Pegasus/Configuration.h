...
#define STRING_CONFIG_H_AUTHOR "(MakerFarm,Pegasus)" // Who made the changes.
...
// #define CUSTOM_MENDEL_NAME "Pegasus"
...
//  #define AUTO_BED_LEVELING_GRID
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 2
      ...
      #define ABL_PROBE_PT_1_Y 200 //215 for 8"
      #define ABL_PROBE_PT_2_X 0
      #define ABL_PROBE_PT_2_Y 0
      #define ABL_PROBE_PT_3_X 140  // 140 for 8"
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT (0)    // X point for Z homing when homing all axis (G28)  X_MAX_LENGTH/2
    #define Z_SAFE_HOMING_Y_POINT (0)    // Y point for Z homing when homing all axis (G28)  Y_MAX_LENGTH/2
