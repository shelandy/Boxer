...
var boxType = 0 // 0=wood standard , 1=extrusion frame ,2=closed box ,3=mini?
var _extrusionSize = 20;
...
function getParameterDefinitions() {
  return [
  { name: '_version', caption: 'Version', type: 'text', initial: "1.2.5 july 6 2015" },
  { 
        name: '_output', 
